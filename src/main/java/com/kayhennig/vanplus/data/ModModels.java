package com.kayhennig.vanplus.data;
...
public class ModModels {
    ...
    private static Model block(String parent, TextureKey... requiredTextureKeys) {
		return new Model(Optional.of(Identifier.of(Vanillaplus.MOD_ID, "block/" + parent)), Optional.empty(), requiredTextureKeys);
	}

    private static Model block(String parent, String variant, TextureKey... requiredTextureKeys) {
		return new Model(Optional.of(Identifier.of(Vanillaplus.MOD_ID, "block/" + parent)), Optional.of(variant), requiredTextureKeys);
	}
}
