...
import com.kayhennig.vanplus.data.ModModels;
import com.kayhennig.vanplus.state.property.ModProperties;
...
public class ModModelProvider extends FabricModelProvider {
    ...
    private void generateBlockStateVerticalSlabModels(BlockStateModelGenerator blockStateModelGenerator) {
        generateBlockStateVerticalSlabModel(blockStateModelGenerator, Blocks.IRON_BLOCK, ModBlocks.IRON_SLAB,
                ModBlocks.IRON_VERTICAL_SLAB);
        generateBlockStateVerticalSlabModel(blockStateModelGenerator, Blocks.LAPIS_BLOCK, ModBlocks.LAPIS_SLAB,
                ModBlocks.LAPIS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabModel(blockStateModelGenerator, Blocks.GOLD_BLOCK, ModBlocks.GOLD_SLAB,
                ModBlocks.GOLD_VERTICAL_SLAB);
        generateBlockStateVerticalSlabModel(blockStateModelGenerator, Blocks.DIAMOND_BLOCK, ModBlocks.DIAMOND_SLAB,
                ModBlocks.DIAMOND_VERTICAL_SLAB);
        generateBlockStateVerticalSlabModel(blockStateModelGenerator, Blocks.EMERALD_BLOCK, ModBlocks.EMERALD_SLAB,
                ModBlocks.EMERALD_VERTICAL_SLAB);

        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.OAK_LOG, ModBlocks.OAK_LOG_SLAB,
                ModBlocks.OAK_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.SPRUCE_LOG,
                ModBlocks.SPRUCE_LOG_SLAB, ModBlocks.SPRUCE_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.BIRCH_LOG, ModBlocks.BIRCH_LOG_SLAB,
                ModBlocks.BIRCH_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.JUNGLE_LOG,
                ModBlocks.JUNGLE_LOG_SLAB, ModBlocks.JUNGLE_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.ACACIA_LOG,
                ModBlocks.ACACIA_LOG_SLAB, ModBlocks.ACACIA_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.DARK_OAK_LOG,
                ModBlocks.DARK_OAK_LOG_SLAB, ModBlocks.DARK_OAK_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.MANGROVE_LOG,
                ModBlocks.MANGROVE_LOG_SLAB, ModBlocks.MANGROVE_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.CHERRY_LOG,
                ModBlocks.CHERRY_LOG_SLAB, ModBlocks.CHERRY_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.CRIMSON_STEM,
                ModBlocks.CRIMSON_STEM_SLAB, ModBlocks.CRIMSON_STEM_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.WARPED_STEM,
                ModBlocks.WARPED_STEM_SLAB, ModBlocks.WARPED_STEM_VERTICAL_SLAB);

        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_OAK_LOG,
                ModBlocks.STRIPPED_OAK_LOG_SLAB, ModBlocks.STRIPPED_OAK_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_SPRUCE_LOG,
                ModBlocks.STRIPPED_SPRUCE_LOG_SLAB, ModBlocks.STRIPPED_SPRUCE_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_BIRCH_LOG,
                ModBlocks.STRIPPED_BIRCH_LOG_SLAB, ModBlocks.STRIPPED_BIRCH_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_JUNGLE_LOG,
                ModBlocks.STRIPPED_JUNGLE_LOG_SLAB, ModBlocks.STRIPPED_JUNGLE_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_ACACIA_LOG,
                ModBlocks.STRIPPED_ACACIA_LOG_SLAB, ModBlocks.STRIPPED_ACACIA_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_DARK_OAK_LOG,
                ModBlocks.STRIPPED_DARK_OAK_LOG_SLAB, ModBlocks.STRIPPED_DARK_OAK_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_MANGROVE_LOG,
                ModBlocks.STRIPPED_MANGROVE_LOG_SLAB, ModBlocks.STRIPPED_MANGROVE_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_CHERRY_LOG,
                ModBlocks.STRIPPED_CHERRY_LOG_SLAB, ModBlocks.STRIPPED_CHERRY_LOG_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_CRIMSON_STEM,
                ModBlocks.STRIPPED_CRIMSON_STEM_SLAB, ModBlocks.STRIPPED_CRIMSON_STEM_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromLogModel(blockStateModelGenerator, Blocks.STRIPPED_WARPED_STEM,
                ModBlocks.STRIPPED_WARPED_STEM_SLAB, ModBlocks.STRIPPED_WARPED_STEM_VERTICAL_SLAB);

        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.OAK_PLANKS, Blocks.OAK_SLAB,
                ModBlocks.OAK_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.SPRUCE_PLANKS, Blocks.SPRUCE_SLAB,
                ModBlocks.SPRUCE_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.BIRCH_PLANKS, Blocks.BIRCH_SLAB,
                ModBlocks.BIRCH_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.JUNGLE_PLANKS, Blocks.JUNGLE_SLAB,
                ModBlocks.JUNGLE_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.ACACIA_PLANKS, Blocks.ACACIA_SLAB,
                ModBlocks.ACACIA_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.DARK_OAK_PLANKS,
                Blocks.DARK_OAK_SLAB,
                ModBlocks.DARK_OAK_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.MANGROVE_PLANKS,
                Blocks.MANGROVE_SLAB,
                ModBlocks.MANGROVE_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.CHERRY_PLANKS, Blocks.CHERRY_SLAB,
                ModBlocks.CHERRY_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.CRIMSON_PLANKS,
                Blocks.CRIMSON_SLAB,
                ModBlocks.CRIMSON_PLANKS_VERTICAL_SLAB);
        generateBlockStateVerticalSlabFromPlankModel(blockStateModelGenerator, Blocks.WARPED_PLANKS, Blocks.WARPED_SLAB,
                ModBlocks.WARPED_PLANKS_VERTICAL_SLAB);
    }
        ...
        return VariantsBlockStateSupplier.create(slabBlock)
                .coordinate(
                        BlockStateVariantMap.create(ModProperties.VERTICAL_SLAB_TYPE)
                                .register(VerticalSlabType.NORTH,
                                        BlockStateVariant.create().put(VariantSettings.MODEL, north))
                                .register(VerticalSlabType.EAST,
                                        BlockStateVariant.create().put(VariantSettings.MODEL, east))
                                .register(VerticalSlabType.SOUTH,
                                        BlockStateVariant.create().put(VariantSettings.MODEL, south))
                                .register(VerticalSlabType.WEST,
                                        BlockStateVariant.create().put(VariantSettings.MODEL, west))
                                .register(VerticalSlabType.DOUBLE_EAST,
                                        BlockStateVariant.create().put(VariantSettings.MODEL, fullEast))
                                .register(VerticalSlabType.DOUBLE_NORTH,
                                        BlockStateVariant.create().put(VariantSettings.MODEL, fullNorth)));
    }
