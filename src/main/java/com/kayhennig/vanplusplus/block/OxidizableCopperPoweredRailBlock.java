...
public class OxidizableCopperPoweredRailBlock extends AbstractRailBlock implements Oxidizable {
    public static final MapCodec<OxidizableCopperPoweredRailBlock> CODEC = RecordCodecBuilder.mapCodec(
		instance -> instance.group(Oxidizable.OxidationLevel.CODEC.fieldOf("weathering_state").forGetter(Degradable::getDegradationLevel), createSettingsCodec())
				.apply(instance, OxidizableCopperPoweredRailBlock::new)
	);
	...
	@Override
	public MapCodec<OxidizableCopperPoweredRailBlock> getCodec() {
		return CODEC;
	}

	public OxidizableCopperPoweredRailBlock(Oxidizable.OxidationLevel oxidationLevel, AbstractBlock.Settings settings) {
		super(true, settings);
